...
public class VarMovimientoSecundario {
    ...
    public int getIdVarmovimientosecunadrio() {
        return idVarmovimientosecunadrio;
    }

    public void setIdVarmovimientosecunadrio(int idVarmovimientosecunadrio) {
        this.idVarmovimientosecunadrio = idVarmovimientosecunadrio;
    }
